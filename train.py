...
parser.add_argument('--root_path', type=str,
                    default='../data/train/A2C_A4C', help='root dir for data')
parser.add_argument('--valid_path', type=str,
                    default='../data/validation/A2C_A4C', help='root dir for valid_data')
...
parser.add_argument('--angle', type=int,
                    default=10, help='angle for rotation')
